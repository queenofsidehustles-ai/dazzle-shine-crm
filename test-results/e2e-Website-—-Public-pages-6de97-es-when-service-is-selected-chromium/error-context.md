...
- Name: e2e.spec.js >> Website — Public pages >> Price calculator updates when service is selected
- Location: tests/e2e.spec.js:89:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_CLOSED at https://www.dazzleandshinemaids.com/#book
Call log:
  - navigating to "https://www.dazzleandshinemaids.com/#book", waiting until "load"
